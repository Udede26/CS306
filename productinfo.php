...
if ($if_commented==true) {
    echo "<p style='Color:black'>You have already commented on this product. You can edit your comment: <i class='fa fa-pencil' aria-hidden='true'></i></p>";
    echo"<div>";
...
echo"<div><button class='w-10 btn btn-sm btn-primary' type='submit sign in'>Submit Comment</button></div>";
echo"</form>";
