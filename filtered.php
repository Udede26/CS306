  ...
  <main>
    ...
    <div id="sidebar">
      <div>
        ...
        <form action = "filtered.php" method = "POST" class="ml-md-2">
        <?php
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo "<div class='form-inline border rounded p-md-2 my-2'> <input type='radio' name='category' id='notugly', value = '$category_name'> <label for='notugly' class='pl-1 pt-sm-0 pt-1'>$category_name</label> </div>";
            }
            ?>
    ...
    <div class="rp-main-content album py-5 bg-light text-center" id="products">
      ...
      $result = mysqli_query($db, "SELECT product.product_name, product.product_description, product.price, product.brand FROM product, productcategory, category WHERE product.product_id = productcategory.product_id AND productcategory.category_id = category.category_id AND category.category_name = \"$category\"");
